...
const selectSalesByMonthDetail = (state) => state.salesByMonth.salesByMonthDetail;

export { selectSalesByMonthData , selectSalesByMonthGraph , selectSalesByMonthDetail };
