...
import { updateBrandRequest, addUserToBrandRequest, fetchBrand } from '@/src/api/brands.api';
...
export default function General() {
  ...
  useEffect(() => {
    if (brandId) {
      fetchBrand(brandId)
        ...
        .catch((error) => router.push('/brands'));
    }
  ...
  const onFinish = (values) => {
    ...
    updateBrandRequest(brandId, data)
      .then((res) => {
        setSubmit(false);
        if (res.status === 200) {
          ...
          <div className='card mb-7'>
            <div className='card-body'>
              {loading ? (
                ...
                <Form {...formItemLayout} layout='vertical' form={editForm} name='register' onFinish={onFinish}>
                  <div className='row'>
                    ...
                    <div className='col-12 col-sm-4 col-md-4 col-lg-6'>
                      ...
                      >
                        <Select size='large' autoFocus autoComplete='off'>
                          <Select.Option value=''>--- Select Marketplace Name</Select.Option>
                  ...
                  <div className='d-flex'>
                    <Form.Item className='d-flex'>
                      <Button htmlType='submit' disabled={submit} className='btn btn-sm btn-primary'>
                        {submit ? (
                          <span>
                            Please wait...
