...
export default function ReportCallOuts(reportData, reportCallOutLoading) {
  return <div className="card card-flush h-xl-100 fadeInRight">
      ...
      <div className="row gx-10">
        <div className="col-md-6 pr-md-2 border-end border-end-dashed">
          <div className="d-flex justify-content-between mb-4">
            {reportCallOutLoading ? TitleLoading() : <>
              <div className="">
          ...
          <div className="d-flex justify-content-between mb-2">
            {reportCallOutLoading ? <></> :
              <>
                ...
                <div className="">
                  <h6 className="mb-0  fw-bolder">{reportData?.upVsLw || '0%'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-2">
            {reportCallOutLoading ? disLoading() :
              <>
                <div className="">
          ...
          <div className="d-flex justify-content-between mb-2">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0  fw-bolder">{reportData?.upVsL4wk || '0%'}</h6>
                </div>
              </>
            }
          ...
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0  fw-bolder">{reportData?.sessionsChange || '0%'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0  fw-bolder">{reportData?.conversionRate || '0%'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0  fw-bolder">{reportData?.avgBuyBoxPercentage || '0%'}</h6>
                </div>
              </>
            }
          </div>
          ...
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwAdSpend || '$0'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwAdRevenue || '$0'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwOrganicSales || '$0'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwTotalSales || '$0'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwRoas || '0%'}</h6>
                </div>
              </>
            }
          </div>
          <div className="d-flex justify-content-between mb-3">
            {reportCallOutLoading ? disLoading() :
              <>
                ...
                <div className="">
                  <h6 className="mb-0 fw-bolder">{reportData?.lwTotalAcos || '0%'}</h6>
                </div>
              </>
            }
          </div>
...
function disLoading() {
  return <>
    ...
    <Skeleton.Button size="small" active={true} shape='default' block={false} />
  </>;
}
